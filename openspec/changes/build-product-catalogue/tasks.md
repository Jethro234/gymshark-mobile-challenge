...
- [x] 11.4 Run a TalkBack pass on device and record the result in the README — done by the user on the physical Pixel 9 Pro; confirmed working correctly, recorded in the README's Accessibility section alongside the RTL result (task 6.8)
